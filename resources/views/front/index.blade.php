	...
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-6 text-center order-1 order-md-2">
				<img class="img-fluid" src="{{ URL::to('public/frontend/images/mobile.png ') }}" alt="screenshot">
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-6 ml-auto justify-content-center">
				<div class="image-content" data-aos="fade-right">
					<img class="img-fluid" src="{{ URL::to('public/frontend/images/feature/feature-new-01.jpg') }}" alt="iphone">
				</div>
			</div>
				...
				<div class="testimonial">
					...
					<ul class="list-inline meta">
						<li class="list-inline-item">
							<img src="{{ URL::to('public/frontend/images/testimonial/feature-testimonial-thumb.jpg') }}" alt="">
						</li>
		...
		<div class="row">
			...
			<div class="col-lg-6 mr-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-left">
					<img class="img-fluid" src="{{ URL::to('public/frontend/images/feature/feature-new-02.jpg') }}" alt="ipad">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-6 align-self-center">
				...
				<div class="service-thumb left" data-aos="fade-right">
					<img class="img-fluid" src="{{ URL::to('public/frontend/images/feature/iphone-ipad.jpg') }}" alt="iphone-ipad">
				</div>
			</div>
				...
				<div class="testimonial-slider owl-carousel owl-theme">
					...
					<div class="item">
						<div class="block shadow">
							...
							<!-- Person Thumb -->
							<div class="image">
								<img src="{{ URL::to('public/frontend/images/testimonial/feature-testimonial-thumb.jpg') }}" alt="image">
							</div>
							<!-- Name and Company -->
